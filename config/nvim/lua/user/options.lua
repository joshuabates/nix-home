...
vim.opt.conceallevel = 3          -- hide TypeScript types by default, max concealment
vim.opt.concealcursor = "nc"      -- show concealed text when cursor is on the line in insert mode
